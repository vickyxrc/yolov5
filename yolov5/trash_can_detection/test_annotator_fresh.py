...
class TestSetAnnotator:
    def __init__(self, root):
        self.root = root
        self.root.title("YOLO Trash Can Annotator - TEST SET")
        
        # Paths specifically for test set
        self.image_dir = "data/images/test_jpg"
        self.label_dir = "data/labels/test"
...
if __name__ == "__main__":
    root = tk.Tk()
    app = TestSetAnnotator(root)  # Note we're using TestSetAnnotator class name
    root.mainloop()
